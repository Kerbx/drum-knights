...
#var Player = preload("res://Scenes/player.tscn") # The player obj.
#
#var tileSize = 16 
#var numRooms = 16 
#var minSize = 4
#var maxSize = 10
#var hSpread = 0 # This is how room will spread over screen's width.
#var cull = 0 # The chance of cutting the room to get more space.
#
#var path
#var startRoom
#
...
#			Map.set_cell(1, Vector2i(x, y), 2,  Vector2i(0, 0), 0)
#
#	var corridors = []
#	for room in $Rooms.get_children():
...
#		for i in range(topleft.x, bottomright.x):
#			for j in range(topleft.y, bottomright.y):
#				Map.set_cell(0, Vector2i(i, j), 2, Vector2i(9, 12))
